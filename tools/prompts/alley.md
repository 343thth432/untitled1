...
Лист с восемью фигурами разрезан и заведён в игру: анфас, профиль, три
четверти со спины, спина, замах, боль, падение на колени, лежит.
Осталось одно — **три четверти анфас** (`alley-1.png`). Сейчас движок
подставляет вместо него анфас.

Лист оказался удачнее отдельных картинок: персонаж выходит одинаковым во
